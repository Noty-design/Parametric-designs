...
male_screw_countersink_style = "none"; // Selects the countersink style: none, cone, or cylinder.
...
female_screw_countersink_style = "none"; // Selects the countersink style: none, cone, or cylinder.
...
module screw_hole_with_countersink( // Defines a through hole with an optional countersink.
    ...
    cylinder(h = hole_length, d = hole_diameter, center = true, $fn = 48); // Creates the negative cylinder for the through hole.
