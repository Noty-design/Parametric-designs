...
lower_jaw_taper_min_thickness = 0.5; 
...
lower_jaw_taper_fade_length = 9.5; 
...
living_hinge_anchor_length = 2.9;
...
eye_depth_into_head = 0.7;
// Higher values move the eye position up towards the top of the head.
eye_vertical_pos = 0.47; // 0 = at center height, 1 = at top of head, 0.5 = perfectly centered in vertical space of the head
// postion in steps of 0.01, higher values move the eye towards the tongue.
eye_horizontal_pos = 10.0; 
